...
"""
This file exists for legacy reasons, as existing custom_components
have started to rely on internals of the components package.
For example, streamlit-option-menu accesses
...
from streamlit.components.v1.default_component_registry import *
